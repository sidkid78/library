...
* **`ar_assessments`**: Stores the output of the AI analysis, including the `accessibility_score`, `identified_hazards` (JSONB), `recommendations` (JSONB), and `fal_ai_visualization_urls`.
